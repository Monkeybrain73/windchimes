namespace windchimes
{
    internal class Const
    {
        ...
        public const string AppId = "windchimes";
        public const string ConfigNameServer = "windchimes-server.json";
        public const string ConfigNameClient = "windchimes-client.json";
